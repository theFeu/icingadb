...
CREATE TABLE history (
  ...
  event_type enum('notification','state_change','downtime_schedule','downtime_start', 'downtime_end','comment_add','comment_remove','flapping_start','flapping_end','acknowledgement_set','acknowledgement_remove') NOT NULL,
  event_time bigint(20) unsigned NOT NULL,
